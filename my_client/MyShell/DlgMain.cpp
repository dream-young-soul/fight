...
void CDlgMain::OnMainQuery()
{
    if (!m_DlgQuery.m_bShow)
    {
        ...
        const int EXCEPTION_NPC_BUY = 10;
        CDlgMain::CloseCurDlg(EXCEPTION_NPC_BUY);
...
void CDlgMain::OnMainFriend()
{
    if ( !m_DlgEnemyFriend.m_bShow)
    {
        ...
        m_DlgEnemyFriend.SetFriendList();
        return;
    }
    else
    {
    ...
    if ( nReturn != -1 )
    {
        ...
        for ( int i = 1; i <= GRID_ICONQUICK_NUM; i++ )
        {
            ...
            if (nItemTypeID == -1 )
            {
                if (i == 1)
                {
                    nItemTypeID = 1010000 * 10 + ICON_TYPE_QUSE;    //红药
                }
                else if (i == 2)
                {
                    nItemTypeID = 1011000 * 10 + ICON_TYPE_QUSE;    //蓝药
                }
            }
            if ( nItemTypeID != -1 )
            {
