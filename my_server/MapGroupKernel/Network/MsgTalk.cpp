...
*/
        ...
        else if (stricmp(szCmd, "addmoney") == 0)
        {
            if (pUser->IsPM())
            {
        ...
        else if (stricmp(szCmd, "additem") == 0)
        {
            if (pUser->IsPM())
            {
        ...
        else if (stricmp(szCmd, "addwskill") == 0)
        {
            if (pUser->IsPM())
            {
        ...
        else if (stricmp(szCmd, "addmagic") == 0)
        {
            if (pUser->IsPM())
            {
                int nSkillType = 0, nLev = 0;
                ...
                {
                    pUser->QueryMagic()->LearnMagic(nSkillType, nLev, bSave == 1);
